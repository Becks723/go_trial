...
type LoginResp struct {
	...
	Auth *MFAInfo         `thrift:"auth,3,required" form:"auth,required" json:"auth,required" query:"auth,required"`
	// 令牌（可选，当未开启MFA时）
	Token *common.TokenInfo `thrift:"token,4,optional" form:"token" json:"token,omitempty" query:"token"`
}
...
func (p *LoginResp) writeField4(oprot thrift.TProtocol) (err error) {
	if p.IsSetToken() {
		if err = oprot.WriteFieldBegin("token", thrift.STRUCT, 4); err != nil {
			goto WriteFieldBeginError
		}
...
type MFAInfo struct {
	// 是否需要MFA校验
	MfaRequired bool `thrift:"mfa_required,1,required" form:"mfa_required,required" json:"mfa_required,required" query:"mfa_required,required"`
	// MFA token
	MfaToken string `thrift:"mfa_token,2,required" form:"mfa_token,required" json:"mfa_token,required" query:"mfa_token,required"`
}
...
func (p *MFAInfo) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("mfa_required", thrift.BOOL, 1); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *MFAInfo) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("mfa_token", thrift.STRING, 2); err != nil {
		goto WriteFieldBeginError
	}
...
type RefreshTokenResp struct {
	Base *common.BaseResp  `thrift:"base,1,required" form:"base,required" json:"base,required" query:"base,required"`
	Data *common.TokenInfo `thrift:"data,2,required" form:"data,required" json:"data,required" query:"data,required"`
}
...
type MFAQrcodeResp struct {
	Base *common.BaseResp `thrift:"base,1,required" form:"base,required" json:"base,required" query:"base,required"`
	Data *MFAQrcodeInfo   `thrift:"data,2,required" form:"data,required" json:"data,required" query:"data,required"`
}
...
func (p *MFAQrcodeInfo) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_MFAQrcodeInfo[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_MFAQrcodeInfo[fieldId]))
}

func (p *MFAQrcodeInfo) ReadField1(iprot thrift.TProtocol) error {
...
func (p *MFAQrcodeInfo) ReadField2(iprot thrift.TProtocol) error {
...
func (p *MFAQrcodeInfo) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("MFAQrcodeInfo"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *MFAQrcodeInfo) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *MFAQrcodeInfo) writeField2(oprot thrift.TProtocol) (err error) {
...
type MFAVerifyReq struct {
	// MFA token
	MfaToken string `thrift:"mfa_token,1,required" form:"mfa_token,required" json:"mfa_token,required" query:"mfa_token,required"`
	// 六位校验码
...
func (p *MFAVerifyReq) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_MFAVerifyReq[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_MFAVerifyReq[fieldId]))
}

func (p *MFAVerifyReq) ReadField1(iprot thrift.TProtocol) error {
...
func (p *MFAVerifyReq) ReadField2(iprot thrift.TProtocol) error {
...
func (p *MFAVerifyReq) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("MFAVerifyReq"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *MFAVerifyReq) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("mfa_token", thrift.STRING, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.MfaToken); err != nil {
		return err
...
func (p *MFAVerifyReq) writeField2(oprot thrift.TProtocol) (err error) {
...
func (p *MFAVerifyResp) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_MFAVerifyResp[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_MFAVerifyResp[fieldId]))
}

func (p *MFAVerifyResp) ReadField1(iprot thrift.TProtocol) error {
	_field := common.NewBaseResp()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *MFAVerifyResp) ReadField2(iprot thrift.TProtocol) error {
	_field := common.NewTokenInfo()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *MFAVerifyResp) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("MFAVerifyResp"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *MFAVerifyResp) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("base", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Base.Write(oprot); err != nil {
...
func (p *MFAVerifyResp) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("data", thrift.STRUCT, 2); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Data.Write(oprot); err != nil {
...
func (p *UserServiceClient) MFAVerify(ctx context.Context, req *MFAVerifyReq) (r *MFAVerifyResp, err error) {
	var _args UserServiceMFAVerifyArgs
	_args.Req = req
	var _result UserServiceMFAVerifyResult
...
func NewUserServiceProcessor(handler UserService) *UserServiceProcessor {
	...
	self.AddToProcessorMap("MFAVerify", &userServiceProcessorMFAVerify{handler: handler})
	return self
}
...
type userServiceProcessorMFAVerify struct {
	handler UserService
}

func (p *userServiceProcessorMFAVerify) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := UserServiceMFAVerifyArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := UserServiceMFAVerifyResult{}
	var retval *MFAVerifyResp
...
type UserServiceRefreshTokenArgs struct {
	Req *RefreshTokenReq `thrift:"req,1,required"`
}
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_UserServiceRefreshTokenArgs[fieldId]))
}
...
type UserServiceMFAVerifyArgs struct {
	Req *MFAVerifyReq `thrift:"req,1,required"`
}
...
func (p *UserServiceMFAVerifyArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UserServiceMFAVerifyArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_UserServiceMFAVerifyArgs[fieldId]))
}

func (p *UserServiceMFAVerifyArgs) ReadField1(iprot thrift.TProtocol) error {
	_field := NewMFAVerifyReq()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Req = _field
...
func (p *UserServiceMFAVerifyArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *UserServiceMFAVerifyArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
type UserServiceMFAVerifyResult struct {
	Success *MFAVerifyResp `thrift:"success,0,optional"`
}
...
func (p *UserServiceMFAVerifyResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UserServiceMFAVerifyResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *UserServiceMFAVerifyResult) ReadField0(iprot thrift.TProtocol) error {
	_field := NewMFAVerifyResp()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Success = _field
...
func (p *UserServiceMFAVerifyResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *UserServiceMFAVerifyResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
