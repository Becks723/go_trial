...
func visitHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	success, err := handler.(video.VideoService).Visit(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func (p *kClient) Feed(ctx context.Context, req *video.FeedQuery) (r *video.FeedResp, err error) {
...
func (p *kClient) List(ctx context.Context, req *video.ListQuery) (r *video.ListResp, err error) {
...
func (p *kClient) Popular(ctx context.Context, req *video.PopularQuery) (r *video.PopularResp, err error) {
...
func (p *kClient) Visit(ctx context.Context, req *video.VisitQuery) (r *video.VisitResp, err error) {
